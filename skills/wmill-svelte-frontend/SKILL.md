---
name: wmill-svelte-frontend
description: Svelte coding guidelines for the Windmill frontend. Use when writing or modifying Svelte code in the Windmill frontend directory.
license: MIT
metadata:
