---
name: wmill-rust-backend
description: Rust coding guidelines for the Windmill backend. Use when writing or modifying Rust code in the Windmill backend directory.
license: MIT
metadata:
